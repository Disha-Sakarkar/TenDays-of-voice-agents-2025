...
FAQ_PATH = os.path.join(BASE_DIR, "shared_data", "day5_zoho_faq.json")
LEADS_DIR = os.path.join(BASE_DIR, "leads")
LEADS_FILE = os.path.join(LEADS_DIR, "zoho_leads.json")
...
class SDRAgent(Agent):
    def __init__(self) -> None:
        super().__init__(
            instructions="""
You are an SDR for Zoho. Greet visitors warmly and ask what brought them here.
...
""".strip()
        ...
        self.lead_schema = {
            ...
            "use_case": "What would you like to use Zoho for?",
...
async def entrypoint(ctx: JobContext):
    ...
    session = AgentSession(
        ...
        tts=murf.TTS(voice="en-IN-priya",
