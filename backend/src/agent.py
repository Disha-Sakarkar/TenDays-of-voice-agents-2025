...
class FraudAgent(Agent):
    ...
    def __init__(self) -> None:
        super().__init__(
            instructions="""
You are a calm, professional fraud detection representative for a fictional bank called "TrustLine".

Your job in each call is:
- Introduce yourself as Monica from TrustLine's fraud department.
